...
| [0018](0018-require-project-owned-architecture-documentation.md)           | Accepted   | Shared           | All active MiKode project repositories                                                                   | Require every active project to describe its current architecture in a project-owned `docs/architecture.md`.                                                                              |
| [0019](0019-use-progressive-context-and-shared-skill-routing.md)           | Accepted   | Shared           | Agent-assisted work across MiKode repositories and supported agent hosts                                 | Select skills and required context progressively through a shared entry point, preserving direct domain workflows and local constraints.                                                  |
