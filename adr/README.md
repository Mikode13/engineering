...
| [0019](0019-use-progressive-context-and-shared-skill-routing.md)           | Proposed   | Shared           | Agent-assisted work across MiKode repositories and supported agent hosts                                 | Select skills and required context progressively through a shared entry point, preserving direct domain workflows and local constraints.                                                  |
